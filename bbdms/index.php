...
We need nearly 5,000 people to give blood every day to meet the needs of hospitals and patients. </p>
                </div>
            </div>
        </div>
        <!-- /.row -->
...
{ ?>
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top img-fluid" src="images/1blood-donorbd.jpg" alt="" ></a>
...
<li>AB positive or AB negative.</li>
            ...
            <div class="col-lg-6">
                <img class="img-fluid rounded" src="images/1blood-donor (1).jpg" alt="">
            </div>
        </div>
        <!-- /.row -->
